...
{
		//instead of this code that was here
...
//    }
    ...
    demoResult = RangingDemoGetResult();
        if( demoResult->RngResultIndex != 0u ){
            ...
            int distance_whole = (int)demoResult->RngDistance;
            int distance_decimal = (int)((demoResult->RngDistance - distance_whole) * 100);

            printf("Distance Ranging = %d.%02d m, RSSI = %d \r\n",
                   distance_whole, distance_decimal, demoResult->RssiValue);
        }
